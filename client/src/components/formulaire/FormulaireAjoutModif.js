...
function FormulaireAjoutModif(props) {
    ...
    //       );
    //   }
    const onValidateForm=props.onValidateForm
    ...
    return (
        <div>
            ...
            <Form.Group className="mb-3" controlId="description">
              ...
              <Form.Control value={submitRecipe.description} placeholder="description" as="textarea" rows={3} />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="personnes">
              ...
              <Form.Control value={submitRecipe.personnes === 0 ? "" : `${submitRecipe.personnes}` } type="number" placeholder="Nombre de personne" />
            </Form.Group>
            <Form.Group className="mb-3" controlId="tempsPreparation">
              <Form.Label>Temps de préparation</Form.Label>
              <Form.Control value={submitRecipe.tempsPreparation === 0 ? "" : `${submitRecipe.tempsPreparation}` } type="number" placeholder="Temps de préparation" />
            </Form.Group>
...
export default FormulaireAjoutModif;